    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.User', verbose_name='创建者')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('create_datetime', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('price_policy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.PricePolicy', verbose_name='价格策略')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.User', verbose_name='用户')),
            ],
        ),
        migrations.CreateModel(
            name='ProjectUser',
            fields=[
                ...
                ('star', models.BooleanField(default=False, verbose_name='星标')),
                ('create_datetime', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('invitee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='b', to='crm.User', verbose_name='邀请者')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='crm.Project', verbose_name='项目')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='a', to='crm.User', verbose_name='参与者')),
            ],
        ),
    ]
